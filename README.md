...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kr6sv1a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kr6sv1a.containers.anotherwebservice.com/
...
```
git clone git@github.com:xeahsoon/container-kr6sv1a.git
cd container-kr6sv1a
```
...
```
docker attach container-kr6sv1a
```
